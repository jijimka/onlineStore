    ...
    return (
        <div className='panel-item-mini'>
            <div className="panel-item-mini__text">
                ...
                <Link rel='noreferrer noopener' to={`/shop/${item.category}/${item.id}`} style={{color:'#076df2'}} className='panel-item-mini__bttns'><span className='floor'>Shop</span> now</Link>
            </div>
